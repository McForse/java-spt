...
public class UserServiceTest {
    ...
    @Test
    public void whenValidName_thenUserShouldBeRegister() {
        SignUpRequest request = new SignUpRequest("testUser", "123456", "123456");
    ...
    @Test
    public void whenValidName_thenUserShouldBeExist() {
        String username = "user";
